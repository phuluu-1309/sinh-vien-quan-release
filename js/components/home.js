...
export function renderHome(state) {
    ...
    return `
        <!-- Main Content -->
        <div class="space-y-4 pt-14 pb-12 animate-fade-in">
            <div class="home-brand-float select-none">
                <div class="home-brand-frame">
                    <img
                        src="https://i.ibb.co/qF7nYZsg/ideogram-v3-0-typography-logo-design-By-Anon-modern-playful-font-slightly-quirky-letterforms-s-0.png"
                        alt="Sinh Viên Quán"
            ...
            <div class="bg-gradient-to-br from-primary to-primary-container text-white p-5 rounded-2xl shadow-md relative overflow-hidden select-none home-membership-card">
