...
export function renderMenu(state) {
    ...
    const appliedVoucher = state.vouchers.find(v => v.id === state.appliedVoucherId);
    const discount = appliedVoucher ? 5000 : 0;
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-1.5">
                                    ...
                                    ${appliedVoucher ? `
                                        <span class="px-1.5 py-0.5 bg-status-red/10 text-status-red rounded text-[9px] font-bold border border-status-red/20">-5k</span>
                                    ` : ''}
                                </div>
                            </div>
                        </div>
